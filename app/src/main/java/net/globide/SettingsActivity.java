...
import net.globide.coloring_book.R;
...
public class SettingsActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIbSettingsShop = (ImageButton) findViewById(R.id.ibSettingsVersion);
    ...
    public void onClick(View v) {
        ...
        // The music toggle button was clicked.
            ...
            case R.id.ibSettingsVersion:
                Toast.makeText(this,"暂无新版更新", Toast.LENGTH_SHORT).show();
                break;
        ...
        if (intentClass != "") {
            try {
                ...
                // intend to trigger.
                selectedClass = Class.forName("net.globide.coloring_book."
                        + intentClass);
                ...
                // intend to trigger.
                try {
                    selectedClass = Class.forName("net.globide.coloring_book." + intentClass);
